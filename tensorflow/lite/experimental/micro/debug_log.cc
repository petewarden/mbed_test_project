...
// `pc.printf("%s", s)`.
// To add an equivalent function for your own platform, create a file like this
// one with your implementation, and place it in a subfolder with named after
// the OS you're targeting. For example, see the Cortex M bare metal version in
